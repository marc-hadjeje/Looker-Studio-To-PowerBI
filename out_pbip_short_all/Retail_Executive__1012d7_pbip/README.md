# Retail_Executive_Dashboard - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **Retail_Executive_Dashboard.SemanticModel/** - TMDL semantic model definition
- **Retail_Executive_Dashboard.Report/** - Report and visual definitions
