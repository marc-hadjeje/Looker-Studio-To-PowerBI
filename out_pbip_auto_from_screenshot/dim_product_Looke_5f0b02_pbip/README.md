# dim_product_Looker_Studio_Example - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **dim_product_Looker_Studio_Example.SemanticModel/** - TMDL semantic model definition
- **dim_product_Looker_Studio_Example.Report/** - Report and visual definitions
