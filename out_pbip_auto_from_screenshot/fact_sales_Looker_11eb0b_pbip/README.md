# fact_sales_Looker_Studio_Example - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **fact_sales_Looker_Studio_Example.SemanticModel/** - TMDL semantic model definition
- **fact_sales_Looker_Studio_Example.Report/** - Report and visual definitions
