# Retail_Board_Storytelling_-_Strategy_Pack - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **Retail_Board_Storytelling_-_Strategy_Pack.SemanticModel/** - TMDL semantic model definition
- **Retail_Board_Storytelling_-_Strategy_Pack.Report/** - Report and visual definitions
