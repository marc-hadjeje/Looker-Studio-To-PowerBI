# Retail_Customer_&_Channel_Insights - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **Retail_Customer_&_Channel_Insights.SemanticModel/** - TMDL semantic model definition
- **Retail_Customer_&_Channel_Insights.Report/** - Report and visual definitions
