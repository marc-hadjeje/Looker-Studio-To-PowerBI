# Retail_Product_Performance - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **Retail_Product_Performance.SemanticModel/** - TMDL semantic model definition
- **Retail_Product_Performance.Report/** - Report and visual definitions
