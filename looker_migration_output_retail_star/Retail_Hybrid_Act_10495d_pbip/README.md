# Retail_Hybrid_Actual_vs_Target_(BigQuery_+_Google_Sheets) - Power BI Project

Generated from Looker Studio report using BigQuery as the data source.

## Project Structure

- **Retail_Hybrid_Actual_vs_Target_(BigQuery_+_Google_Sheets).SemanticModel/** - TMDL semantic model definition
- **Retail_Hybrid_Actual_vs_Target_(BigQuery_+_Google_Sheets).Report/** - Report and visual definitions
